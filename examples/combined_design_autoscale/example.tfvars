...
vpcs = {
  ...
  app1_vpc = {
    ...
    subnets = {
      ...
      "10.104.3.0/24"   = { az = "eu-west-1a", subnet_group = "app1_gwlbe" }
      "10.104.131.0/24" = { az = "eu-west-1b", subnet_group = "app1_gwlbe" }
    }
    routes = {
      # Value of `next_hop_key` must match keys use to create TGW attachment, IGW, GWLB endpoint or other resources
      # Value of `next_hop_type` is internet_gateway, nat_gateway, transit_gateway_attachment or gwlbe_endpoint
  ...
  app2_vpc = {
    ...
    subnets = {
      ...
      "10.105.3.0/24"   = { az = "eu-west-1a", subnet_group = "app2_gwlbe" }
      "10.105.131.0/24" = { az = "eu-west-1b", subnet_group = "app2_gwlbe" }
    }
    routes = {
      # Value of `next_hop_key` must match keys use to create TGW attachment, IGW, GWLB endpoint or other resources
      # Value of `next_hop_type` is internet_gateway, nat_gateway, transit_gateway_attachment or gwlbe_endpoint
