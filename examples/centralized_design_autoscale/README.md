...
| <a name="input_gwlbs"></a> [gwlbs](#input\_gwlbs) | A map defining Gateway Load Balancers.<br><br>Following properties are available:<br>- `name`: name of the GWLB<br>- `vpc`: key of VPC<br>- `subnet`: key of subnet<br><br>Example:<pre>gwlbs = {<br>  security_gwlb = {<br>    name   = "security-gwlb"<br>    vpc    = "security_vpc"<br>    subnet = "gwlb"<br>  }<br>}</pre> | <pre>map(object({<br>    name   = string<br>    vpc    = string<br>    subnet = string<br>  }))</pre> | `{}` | no |
...
| <a name="input_natgws"></a> [natgws](#input\_natgws) | A map defining NAT Gateways.<br><br>Following properties are available:<br>- `name`: name of NAT Gateway<br>- `vpc`: key of VPC<br>- `subnet`: key of subnet<br><br>Example:<pre>natgws = {<br>  security_nat_gw = {<br>    name   = "natgw"<br>    vpc    = "security_vpc"<br>    subnet = "natgw"<br>  }<br>}</pre> | <pre>map(object({<br>    name   = string<br>    vpc    = string<br>    subnet = string<br>  }))</pre> | `{}` | no |
