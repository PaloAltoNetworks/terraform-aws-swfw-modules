...
| <a name="input_iam_policies"></a> [iam\_policies](#input\_iam\_policies) | A map defining an IAM policies, roles etc. | `any` | <pre>{<br>  "lambda": {<br>    "create_lambda_policy": true,<br>    "delicense_ssm_param_name": "secret_name",<br>    "principal_role": "lambda.amazonaws.com",<br>    "role_name": "lambda_role"<br>  },<br>  "spoke": {<br>    "create_instance_profile": true,<br>    "instance_profile_name": "centralized_spoke_profile",<br>    "policy_arn": "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore",<br>    "role_name": "spoke_role"<br>  },<br>  "vmseries": {<br>    "create_instance_profile": true,<br>    "create_vmseries_policy": true,<br>    "instance_profile_name": "centralized_vmseries_profile",<br>    "role_name": "vmseries_role"<br>  }<br>}</pre> | no |
