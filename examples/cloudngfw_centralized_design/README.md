...
| [aws_ec2_transit_gateway_route_table_propagation.app1](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway_route_table_propagation) | resource |
| [aws_ec2_transit_gateway_route_table_propagation.app2](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway_route_table_propagation) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_application_lb"></a> [application\_lb](#input\_application\_lb) | An ALB for application in spokes VPC | <pre>map(object({<br>    name            = string<br>    subnet_group    = string<br>    vpc             = string<br>    security_group  = string<br>    target_group_az = string<br>    vms             = set(string)<br>    rules           = any<br>  }))</pre> | n/a | yes |
