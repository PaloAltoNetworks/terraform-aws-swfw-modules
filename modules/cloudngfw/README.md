...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_account_id"></a> [aws\_account\_id](#input\_aws\_account\_id) | The AWS Account ID. | `string` | `null` | no |
| <a name="input_create_log_profiles"></a> [create\_log\_profiles](#input\_create\_log\_profiles) | The log profiles can be disable if link\_id integration allows logging to CDL. | `bool` | `true` | no |
| <a name="input_create_security_rules"></a> [create\_security\_rules](#input\_create\_security\_rules) | The option allows disable local rule stack creation to set link\_id. | `bool` | `true` | no |
...
| <a name="input_global_rulestack"></a> [global\_rulestack](#input\_global\_rulestack) | The global rulestack for this NGFW. | `string` | `null` | no |
| <a name="input_link_id"></a> [link\_id](#input\_link\_id) | The link ID of integrated policy management tool. | `string` | `null` | no |
...
| <a name="output_fw_id"></a> [fw\_id](#output\_fw\_id) | Id of the Cloud NGFW resource |
<!-- END_TF_DOCS -->
