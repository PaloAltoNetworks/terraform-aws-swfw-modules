...
| <a name="input_tags_dest"></a> [tags\_dest](#input\_tags\_dest) | List of resources that will be tagged when launched via ASG | `list(string)` | <pre>[<br>  "instance",<br>  "volume",<br>  "network-interface"<br>]</pre> | no |
