...
| <a name="input_arm_deployment"></a> [arm\_deployment](#input\_arm\_deployment) | Whether to deploy an ARM-based VM-Series instance. When set to `true`, the module will search for an ARM AMI. | `bool` | `false` | no |
...
| <a name="input_ebs_volume_type"></a> [ebs\_volume\_type](#input\_ebs\_volume\_type) | Indicates the type of ebs volume for EC2 instance | `string` | `"gp2"` | no |
